...
const AdminParceiros = () => {
  ...
  const handleAddLocal = () => {
    if (localInput.trim()) {
      setFormData(prev => ({
        ...prev,
        locais: [...prev.locais, localInput.trim()]
      }));
      setLocalInput('');
    }
  };
        ...
        >
          ...
          <DialogContent dividers>
            ...
            {currentTab === 0 && (
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <TextField
                  ...
                  required
                  placeholder="Ex: Chico do Caranguejo"
                />
                ...
                <Typography variant="h6" sx={{ mt: 2 }}>Contato</Typography>
                ...
                <TextField
                  ...
                  helperText="Apenas números com DDI"
                />
            ...
            {currentTab === 2 && (
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <Alert severity="info">
                  Adicione os nomes dos locais onde o parceiro atua (ex: "Centro", "Copacabana", "Ipanema")
                </Alert>
                ...
                <Box sx={{ display: 'flex', gap: 1 }}>
                  <TextField
                    ...
                    placeholder="Ex: Unidade Centro, Filial Copacabana"
                    onKeyPress={(e) => e.key === 'Enter' && handleAddLocal()}
                  />
                  <Button variant="contained" onClick={handleAddLocal} startIcon={<AddIcon />}>
                    Adicionar
                  </Button>
                </Box>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                  {formData.locais.map((local, index) => (
                    <Chip
                      key={index}
                      label={local}
                      onDelete={() => handleRemoveLocal(index)}
                      color="primary"
                    />
                  ))}
                </Box>
          ...
          <DialogActions>
            ...
            <Button
              ...
              disabled={loading}
            >
              {loading ? <CircularProgress size={24} /> : selectedParceiro ? 'Atualizar' : 'Criar'}
            </Button>
          </DialogActions>
        </Dialog>
